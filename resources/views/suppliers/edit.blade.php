...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Ubah data supplier</p>
        </div>
    ...
    <div id="deleteSupplierModal" x-data="{ show: false }" x-show="show" x-cloak
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" @click.stop>
            <div class="mt-3">
                ...
                <p class="text-gray-600 mb-4">Apakah Anda yakin ingin menghapus supplier ini? Purchase order yang terkait
                    akan tetap ada.</p>
