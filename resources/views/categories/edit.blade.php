...
@section('content')
    ...
    <div id="deleteCategoryModal" x-data="{ show: false }" x-show="show" x-cloak
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" @click.stop>
            <div class="mt-3">
                ...
                <p class="text-gray-600 mb-4">Apakah Anda yakin ingin menghapus kategori ini? Produk yang terkait dengan
                    kategori ini tidak akan terpengaruh.</p>
